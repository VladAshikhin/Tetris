...
class LBlock : TetrisBlock() {
        ...
        when (this.position) {
            ...
            Position.SECOND -> {
                ...
                if (block1.left.equals(leftBorder)) {
                    ...
                    block2.top = block2.top - 140
                    block2.bottom = block2.bottom - 140
                } else {
                    block1.left = block1.left - 70
                    block1.top = block1.top + 70
                    block1.right = block1.right + 70
    ...
    init {
        ...
        cells.add(Rect(spacing + cellWidth * 4, spacing + cellHeight, spacing + cellWidth * 5, spacing + cellHeight * 2))
    }
}